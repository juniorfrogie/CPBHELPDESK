<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="edit_req_detail.aspx.cs" Inherits="pages_edit_req_detail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="page-header">
        <h2 style="margin-left:10px;">Edit Request Detail</h2>
    </div>
    ...
    <div class="col-lg-4" style="margin-top:15px;">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                      <label class="pull-left">Purpose/Justification</label>
